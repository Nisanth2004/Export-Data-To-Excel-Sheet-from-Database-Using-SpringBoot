...
public class ExcelExportUtils
{
    ...
    private void createHaederRow()
    {
        // sheet name
        sheet=workbook.createSheet("CIT College Student BIO-DATA");
        Row row=sheet.createRow(0);
        CellStyle style= workbook.createCellStyle();
        // set font of the workbook
        XSSFFont font=workbook.createFont();
        font.setBold(true);
        font.setFontHeight(20);
        style.setFont(font);
        style.setAlignment(HorizontalAlignment.CENTER);
        createCell(row,0,"Customers Information",style);
